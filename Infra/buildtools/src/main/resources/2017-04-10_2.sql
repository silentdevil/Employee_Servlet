...
INSERT INTO EMPLOYEES(employeeid, lastname, firstname, middlename, suffix, title, address, birthday, gwa, datehired, currentlyhired, contact)
	VALUES(1, 'CARPIO','JIM MIKAEL','ROXAS','','',1,'1996-05-21',4,'2017-01-23','T',1);
...
INSERT INTO EMPLOYEES(employeeid, lastname, firstname, middlename, suffix, title, address, birthday, gwa, datehired, currentlyhired, contact)
	VALUES(2, 'CABANLIG','ERVEIN','BRAVO','','',2,'1993-02-01',4,'2016-04-02','F',2);

INSERT INTO EMPLOYEES(employeeid, lastname, firstname, middlename, suffix, title, address, birthday, gwa, datehired, currentlyhired, contact)
	VALUES(3, 'CARPIO','JASSMYNE','ROXAS','','',1,'1996-05-21',4,'2017-01-23','T',1);